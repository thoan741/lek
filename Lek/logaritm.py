...
while counter < 1000: #stanna vid det angivna primtalet
...
print(" Logaritmen för alla primtal upp till denna adderade är " + str(logarithm)) #alla primtals logaritm fram till n:te primtalet adderade
